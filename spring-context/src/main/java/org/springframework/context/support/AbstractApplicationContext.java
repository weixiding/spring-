...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			// 更新维护的beanfactory，相当于重新关闭在开启并加载bean
	...
	/**
	 * 分析工作:bean的加载过程
	 *		根据继承关系会调用子类AbstractRefreshableApplicationContext.refreshBeanFactory() 的方法
	 */
	protected ConfigurableListableBeanFactory obtainFreshBeanFactory() {
		//此处是一个抽象方法，需要子类实现,为什么交给子类去实现呢，因为我们不知道会用beanfactory，因为在该过程中我们
		//会创建beanfactory 工厂
		refreshBeanFactory();
	...
	//---------------------------------------------------------------------
	//此处使用了装饰者设计模式，将具体的实现交给了自己拥有的factory
	//---------------------------------------------------------------------
